    ...
    <nav className="bg-surface border-b border-border" style={{ boxShadow: 'var(--shadow-sm)' }}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex justify-between items-center">
        ...
        <div className="hidden sm:flex items-center gap-8">
          ...
          <Link href="/subscriptions" className="text-sm font-medium text-text-secondary hover:text-primary transition-colors">
            Subscriptions
          </Link>
          <Link href="/settings" className="text-sm font-medium text-text-secondary hover:text-primary transition-colors">
            Settings
          </Link>
          <Link
            href="/security"
